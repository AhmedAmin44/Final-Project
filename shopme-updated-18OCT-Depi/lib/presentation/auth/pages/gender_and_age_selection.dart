...
class GenderAndAgeSelectionPage extends StatelessWidget {
  ...
  Widget _tellUs() {
    return  Text(
      LocaleKeys.GenderAndAge_Tell_us_about_yourself.tr(),
      style: TextStyle(
        fontSize: 24,
  ...
  Widget _genders(BuildContext context) {
    return BlocBuilder<GenderSelectionCubit,int>(
      builder: (context,state) {
        ...
        children: [
          genderTile(context,1,LocaleKeys.GenderAndAge_Men.tr()),
          const SizedBox(width: 20,),
          genderTile(context,2,LocaleKeys.GenderAndAge_Women.tr()),
        ],
      );
      }
  ...
  Widget howOld() {
    return  Text(
      LocaleKeys.GenderAndAge_How_old_are_you.tr(),
      style: TextStyle(
        fontSize: 18,
        fontWeight: FontWeight.w500
      ),
        ...
        child: Builder(
          builder: (context) {
            return BasicReactiveButton(
              ...
              title: LocaleKeys.GenderAndAge_Finish.tr()
            );
          }
        ),
      ),
