...
class EnterPasswordPage extends StatelessWidget {
  ...
  Widget _siginText(BuildContext context) {
    return  Text(
      LocaleKeys.EnterPassword_Sign_in.tr(),
      style: TextStyle(
        fontSize: 32,
  ...
  Widget _passwordField(BuildContext context) {
    return TextField(
      ...
      decoration:  InputDecoration(
        hintText: LocaleKeys.EnterPassword_Enter_Password.tr()
      ),
    );
  }
    ...
    return Builder(
      builder: (context) {
        return BasicReactiveButton(
          ...
          title: LocaleKeys.EnterPassword_Continue.tr()
        );
      }
    );
  }
  ...
  Widget _forgotPassword(BuildContext context) {
    return RichText(
      text: TextSpan(
        children:  [
           TextSpan(
            text: LocaleKeys.EnterPassword_Forgot_password.tr()
          ),
           TextSpan(
            text: LocaleKeys.EnterPassword_Reset.tr(),
